...
public class LeaveForm extends javax.swing.JFrame {
    ...
    private void InsertLeaveForm() {
        ...
        try {
            ...
            boolean isSuccess = objLeaveController.InsertLeaveForm(objLeave);
            if (isSuccess == true) {
    ...
    private int getLeaveTypeId() {
        ...
        try {
            ...
            Logger.getLogger(LeaveForm.class.getName()).log(Level.SEVERE, null, ex);
